...
export type UserRole = 'admin' | 'inventory_staff' | 'sales_staff' | 'production_staff';
...
export type Page = 'dashboard' | 'inventory' | 'sales' | 'production' | 'alerts';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {currentPage === 'inventory' && hasAccess('inventory') && <InventoryPage />}
        {currentPage === 'sales' && hasAccess('sales') && <SalesPage />}
        {currentPage === 'production' && hasAccess('production') && <ProductionPage />}
